...
void apMain()
{
	...
	while(1)	
	{
		...
		if(millis() - pre_time >= 50)
		{
			...
			//sprintf(buff, "%1.3f %1.3f %1.3f %1.3f", quat[0], quat[1], quat[2], quat[3]);
			//HC06Printf("imu: x:%d, y:%d, z:%d\n", acc[0], acc[1], acc[2]);
			/*
			HC06Printf("@");
			
			sprintf(buff, "%d %d %d %1.3f %1.3f %1.3f %1.3f", imu1.accRaw[0], imu1.accRaw[1], imu1.accRaw[2], imu1.quat[0], imu1.quat[1], imu1.quat[2], imu1.quat[3]);
			HC06Printf("%s,", buff);
			sprintf(buff, "%d %d %d %1.3f %1.3f %1.3f %1.3f", imu2.accRaw[0], imu2.accRaw[1], imu2.accRaw[2], imu2.quat[0], imu2.quat[1], imu2.quat[2], imu2.quat[3]);
			HC06Printf("%s,", buff);
			sprintf(buff, "%d %d %d %1.3f %1.3f %1.3f %1.3f", imu3.accRaw[0], imu3.accRaw[1], imu3.accRaw[2], imu3.quat[0], imu3.quat[1], imu3.quat[2], imu3.quat[3]);
			HC06Printf("%s,", buff);
			sprintf(buff, "%d %d %d %1.3f %1.3f %1.3f %1.3f", imu4.accRaw[0], imu4.accRaw[1], imu4.accRaw[2], imu4.quat[0], imu4.quat[1], imu4.quat[2], imu4.quat[3]);
			HC06Printf("%s,", buff);
			sprintf(buff, "%d %d %d %1.3f %1.3f %1.3f %1.3f", acc[0], acc[1], acc[2], quat[0], quat[1], quat[2], quat[3]);
			HC06Printf("%s\n", buff);
			*/
			/*
			HC06Printf("%4d %4d %4d %4d %4d %4d %4d", 
			...
			HC06Printf("%4d %4d %4d %4d %4d %4d %4d\n", 
									(int16_t)(acc[0]*1000), (int16_t)(acc[1]*1000), (int16_t)(acc[2]*1000), 
									(int16_t)(quat[0]*1000), (int16_t)(quat[1]*1000), (int16_t)(quat[2]*1000), (int16_t)(quat[3]*1000));
			*/
			/*
			HC06Printf("@");
			sprintf(buff, "%d %d %d %d %d %d %d,", 
									(int16_t)(imu1.ax*1000), (int16_t)(imu1.ay*1000), (int16_t)(imu1.az*1000), 
									(int16_t)(imu1.quat[0]*1000), (int16_t)(imu1.quat[1]*1000), (int16_t)(imu1.quat[2]*1000), (int16_t)(imu1.quat[3]*1000));
			HC06Write((uint8_t *)buff, strlen(buff));
